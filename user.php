...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color : rgb(87, 115,241);">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="nav navbar-nav navbar-right" >
        <li ><a href = "index.html" style="color: #070707;"><span class = "glyphicon glyphicon-home"></span> Home</a></li>
        <li><a href="user.php" style="color: #070707;"><span class="glyphicon glyphicon-user"></span> New Users</a></li>
        <li><a href="transaction.php" style="color: #070707;"><span class="glyphicon glyphicon-transfer"></span> Transfer Money</a></li>
        <li class="active"><a href="history.php" style="color: #070707;"><span class="glyphicon glyphicon-inbox"></span> History</a></li>
    </ul>
    </div>
  </div>
</nav>
